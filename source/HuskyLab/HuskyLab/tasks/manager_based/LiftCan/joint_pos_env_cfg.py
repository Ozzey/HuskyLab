...
from HuskyLab.Robots.ur5_cfg import UR5_CFG
from HuskyLab.tasks.manager_based.LiftCan import mdp
from HuskyLab.tasks.manager_based.LiftCan.lift_env_cfg import LiftEnvCfg
from HuskyLab import package_root


@configclass
class UR5CanLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        self.scene.object = RigidObjectCfg(
            ...
            init_state=RigidObjectCfg.InitialStateCfg(
                pos=[0.5, 0, 0.0]   # initial position of the object
            ),
            spawn=UsdFileCfg(
                # usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Blocks/DexCube/dex_cube_instanceable.usd",
                usd_path = os.path.join(package_root, "Assets", "tuna_can.usd"),
                scale=(0.8, 0.8, 0.8),
