...
from HuskyLab.tasks.manager_based.LiftMug import mdp
from HuskyLab.tasks.manager_based.LiftMug.lift_env_cfg import LiftEnvCfg
from HuskyLab import package_root


@configclass
class UR5MugLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        self.scene.object = RigidObjectCfg(
            ...
            spawn=UsdFileCfg(
                ...
                usd_path = os.path.join(package_root, "Assets", "mug.usd"),
                scale=(0.8, 0.8, 0.8),
