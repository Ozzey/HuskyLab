...
from ur5_isaaclab.tasks.manager_based.lift.lift_env_cfg import LiftEnvCfg
    ...
    def __post_init__(self):
        ...
        self.scene.object = RigidObjectCfg(
            ...
            init_state=RigidObjectCfg.InitialStateCfg(
                pos=[1.0, 0, 10.0],   # initial position of the object
                rot=[1.0, 0.0, 0.0, 0.0], 
            ),
            spawn=UsdFileCfg(
                usd_path=f"/home/jacob/Desktop/Projects/ur5_isaaclab-master/assets/objects/cylinder.usd",
