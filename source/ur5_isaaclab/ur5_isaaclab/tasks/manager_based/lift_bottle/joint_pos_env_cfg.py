...
from ur5_isaaclab.tasks.manager_based.lift_bottle import mdp
from ur5_isaaclab.tasks.manager_based.lift_bottle.lift_env_cfg import LiftEnvCfg



@configclass
class UR5BottleLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        self.scene.object = RigidObjectCfg(
            ...
            init_state=RigidObjectCfg.InitialStateCfg(
                pos=[0.5, 0.0, 0.1]   # initial position of the object
            ),
            spawn=UsdFileCfg(
                # usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Blocks/DexCube/dex_cube_instanceable.usd",
                usd_path = "/home/jacob/Desktop/Projects/ur5_isaaclab-master/assets/bottle.usd",
                # scale=(0.6, 0.6, 0.6),
                scale=(1.0, 1.0, 1.0),
...
@configclass
class UR5BottleLiftEnvCfg_PLAY(UR5BottleLiftEnvCfg):
    def __post_init__(self):
        super().__post_init__()
