...
# This trainingscript is made for training with linear movement objects.
# To train: python scripts/rsl_rl/train.py --task=Isaac-Lift-Cube-UR5-Moving-v0 --headless
# To test: python scripts/rsl_rl/play.py --task=Isaac-Lift-Cube-UR5-Moving-v0 --num_envs=1
...
class CommandsCfg:
    ...
    # The MDP will generate commands for the object pose.
...
class EventCfg:
    ...
    # Reset the object position within a specified range.
    ...
    # Declare the object linear velocity range
