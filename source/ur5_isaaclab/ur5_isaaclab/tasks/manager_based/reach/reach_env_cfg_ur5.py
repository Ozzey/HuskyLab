...
# TO run training: python scripts/rsl_rl/train.py --task=Isaac-Reach-UR5-v0 --headless
# TO play the train policy: python scripts/rsl_rl/play.py --task=Isaac-Reach-UR5-v0 --numm_envs=1
